...
var g = jedi.indexOf('Yoda')
var firstJedi = jedi.splice([g],1)[0];
...
var h = jedi.indexOf('Obi-Wan')
var secondJedi = jedi.splice([h],1)[0];
...
function tripleTheFun(par){
  if (+par){
  return Number(par) + Number(par) + Number(par)
}
else return par + par + par;
}
